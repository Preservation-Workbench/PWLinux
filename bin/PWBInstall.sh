...
apt-get install -y wimtools python3-pandas graphviz python3-lxml python3-tk openjdk-11-jdk img2pdf imagemagick python3-pgmagick graphicsmagick onlyoffice-documentbuilder abiword;
