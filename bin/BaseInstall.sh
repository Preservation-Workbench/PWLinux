...
python3-pgmagick graphicsmagick graphviz img2pdf bellsoft-java8-runtime-full okular dex arj p7zip-rar unace fzf fd-find pdfarranger krop linux-libc-dev \
libsss-nss-idmap0;
